...
__global__ void me( pixel *dev_mb_enc, pixel *dev_fref_buf, x264_mvc_t *mvc, int me_range, int stride_ref , int mb_x, int mb_y, int bmx, int bmy);
...
extern "C" void cuda_me( x264_cuda_t *c, int *p_bmx, int *p_bmy, int *p_bcost ) {
	...
	me<<<1, grid_sad>>>( c->dev_fenc_buf, c->dev_fref_buf, mvc, me_range, stride_buf, mb_x, mb_y, *p_bmx, *p_bmy);
...
__global__ void me( pixel *dev_fenc_buf, pixel *dev_fref_buf, x264_mvc_t *mvc, int me_range, int stride_buf , int mb_x, int mb_y, int bmx, int bmy) {
